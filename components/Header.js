  ...
  return (
    <div className='bg-white flex items-center p-2 shadow-md top-0 sticky z-50 h-16 '>
        ...
        <div className='flex min-w-fit'>
            <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Facebook_Logo_%282019%29.png/600px-Facebook_Logo_%282019%29.png' alt="logo" height={40} width={40}></Image>
        ...
        {/*Right*/}
            <div className='flex items-center justify-end min-w-fit space-x-2'>
             <Image src={session?.user.image} height={40} width={40} alt="profilePic" className="rounded-full border border-gray-300 cursor-pointer"
             onClick={signOut}
             >
            </Image>
